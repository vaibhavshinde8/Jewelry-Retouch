        ...
        <div className="form-layout">
          ...
          <div className="contact-info">
            ...
            <div className="contact-main-div" >
              <a
                href="" // Link to Google Maps with the address
                target="_blank"
              ...
              <p style={{ textAlign: "start" }}>India</p>
            </div>
            <div className="contact-main-div">
              <a
                href="tel:+0134567890" // Click to call phone number
                className="contact-item"
              >
                <img
              ...
              <p>
                <strong>Contact:</strong> 0134567890
              </p>
            </div>
            <div className="contact-main-div" >
              <a
            ...
            <div className="form-row">
              <div className="" style={{ display: "flex", flexDirection: "column", flex: "auto" }}>
                ...
                <input
                  ...
                  style={{
                    boxShadow: "inset 2px 2px 10px rgba(0, 0, 0, 0.3)", color: "black",
                    ":placeholder": {
                      color: "black",
                    },
                  }}
